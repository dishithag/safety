...
func TestLoadCIDReport(t *testing.T) {
	report, err := summarizer.LoadCIDReport("../../testdata/sample_audit_reports/cids/0f53593ceae34995af8fd295c18f1e25.json")
	if err != nil {
...
func TestLoadCloudAuditReport(t *testing.T) {
	report, err := summarizer.LoadCloudAuditReport("../../testdata/sample_audit_reports/cloud_audit.json")
	if err != nil {
