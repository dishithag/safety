...
const (
	SummaryVersion            = "v6"
	FallbackNarrativeProvider = "deterministic-fallback"
...
// FallbackSummaryProfile marks a deterministic summary as degraded so a later GenAI run retries it.
func FallbackSummaryProfile(profile SummaryProfile) SummaryProfile {
	profile.NarrativeProvider = FallbackNarrativeProvider
	profile.Model = ""
	return profile
}
