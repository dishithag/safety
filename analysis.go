...
type PlatformAnalysis struct {
	...
	ZeroSignals              []SignalAnalysis `json:"-"`
...
func AnalyzeReport(report *shared.CIDReport) (*ReportAnalysis, error) {
	...
	analysis := &ReportAnalysis{
		...
		HasOSScore:               report.HasAverageOSScore(),
		HasSensorConfigScore:     report.HasAverageSensorConfigScore(),
...
func platformScoreAvailability(platform shared.PlatformSummary) (bool, bool) {
	return platform.HasAverageOSScore(), platform.HasAverageSensorConfigScore()
}
